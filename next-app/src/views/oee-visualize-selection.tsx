import {
  fetchOEEMachineSetting,
  fetchOEEOperatorSetting,
  fetchOEEProductSetting,
} from "@/actions/oee-setting.action";
...
const OEEVisualizeSelection: FC<IProps> = ({ picker = "date" }: IProps) => {
  ...
  useEffect(() => {
    ...
    if (selectedProduct !== "" && selectedProductLine !== "") {
      ...
      fetchOEEOperatorSetting(selectedProduct, selectedProductLine, {
        signal: controller.signal,
      });
      fetchOEEMachineSetting(selectedProduct, selectedProductLine, {
        signal: controller.signal,
      });
    }

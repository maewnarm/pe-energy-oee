...
import { AirYearlyStore, ElectricYearlyStore, EnergySettingStore } from '@/store'
...
const EnergyYearly: NextPage = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProduct !== '' && selectedProductLine !== '' && selectedDate !== '') {
      ...
      fetchElectricYearly(selectedProduct, selectedProductLine, selectedDate, { signal: electricAbortController.signal })

      airAbortController = new AbortController()
      fetchAirYearly(selectedProduct, selectedProductLine, selectedDate, { signal: electricAbortController.signal })
    }
  ...
  return (
    <>
      ...
      <Layout
        title="Energy Visualization - Yearly"
        backable>
